...
package c.anurag.cropannotate.crop;
...
import c.anurag.cropannotate.crop.view.CropImageView;
...
public final class CropImage {
  ...
  /** The key used to pass crop image source URI to {@link c.anurag.cropannotate.crop.activity.CropImageActivity}. */
  public static final String CROP_IMAGE_EXTRA_SOURCE = "CROP_IMAGE_EXTRA_SOURCE";

  /** The key used to pass crop image options to {@link c.anurag.cropannotate.crop.activity.CropImageActivity}. */
  public static final String CROP_IMAGE_EXTRA_OPTIONS = "CROP_IMAGE_EXTRA_OPTIONS";

  /** The key used to pass crop image bundle data to {@link c.anurag.cropannotate.crop.activity.CropImageActivity}. */
  public static final String CROP_IMAGE_EXTRA_BUNDLE = "CROP_IMAGE_EXTRA_BUNDLE";

  /** The key used to pass crop image result data back from {@link c.anurag.cropannotate.crop.activity.CropImageActivity}. */
  ...
  /**
   * The request code used to start {@link c.anurag.cropannotate.crop.activity.CropImageActivity} to be used on result to identify the
   * this specific request.
   */
  public static final int CROP_IMAGE_ACTIVITY_REQUEST_CODE = 203;

  /** The result code used to return error from {@link c.anurag.cropannotate.crop.activity.CropImageActivity}. */
   ...
   * c.anurag.cropannotate.crop.activity.CropImageActivity} to crop the selected image.<br>
  ...
  /**
   * Create {@link ActivityBuilder} instance to start {@link c.anurag.cropannotate.crop.activity.CropImageActivity} to crop the given
   * image.<br>
   * Result will be received in {@link Activity#onActivityResult(int, int, Intent)} and can be
   * retrieved using {@link #getActivityResult(Intent)}.
   *
  ...
  /**
   * Get {@link c.anurag.cropannotate.crop.activity.CropImageActivity} result data object for crop image activity started using {@link
   * #activity(Uri)}.
   *
  ...
  public static final class ActivityBuilder {
    ...
    /** Get {@link c.anurag.cropannotate.crop.activity.CropImageActivity} intent to start the activity. */
    ...
    /**
     * Start {@link c.anurag.cropannotate.crop.activity.CropImageActivity}.
     *
    ...
    /**
     * the title of the {@link c.anurag.cropannotate.crop.activity.CropImageActivity}.<br>
     * <i>Default: ""</i>
     */
